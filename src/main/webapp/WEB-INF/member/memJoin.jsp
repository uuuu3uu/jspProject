  ...
  <script>
    ...
    function idCheck() {
    	...
    	if(mid.trim() == "") {
    		...
    		idCheckSw = 1;
    		window.open(url,"nWin","width=500px,height=280px");
    	}
    }
...
<!--     <div class="form-group">
    ...
    <div class="form-group mt-5 mb-5">
	    ...
	    <input type="button" class="btn btn-sm" value="돌아가기" onclick="location.href='${ctp}/memLogin.mem';"/>
    </div>
